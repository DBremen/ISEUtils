...
<#$DisplayName = "Expand zen-Code"            
$Action      = {
    $psISE.CurrentFile.Editor.SelectCaretLine()
    $psISE.CurrentFile.Editor.InsertText((zenCode $psISE.CurrentFile.Editor.CaretLineText))
}            
$ShortCut    = "CTRL+SHIFT+W"            
            
$menu=$psISE.CurrentPowerShellTab.AddOnsMenu.Submenus.Add($DisplayName, $Action, $ShortCut)#>
...
#$psISE.CurrentPowerShellTab.AddOnsMenu.Submenus[-1]
<#[void]$psISE.CurrentPowerShellTab.AddOnsMenu.Submenus.Remove($menu)

...
$fileTree ={
    #did not find a way around hard coding the path
    ipmo C:\Scripts\ps1\Utils\ISEUtils\resources\DirectorySearcher.dll
...
$classes = "NewISEMenu","NewISESnippet","FileTree"
$namespace = "ISEUtils"
ConvertTo-ISEAddOn -ScriptBlock ($newISEMenu,$newISESnippet,$fileTree) -NameSpace $namespace -DLLPath $dllPath -class $classes
